...
import { VIDEO_UPLOAD_ENABLED } from '../constants.js';
    ...
    <div className="stage-empty">
      ...
      >
        ...
        <section className="prototype-source" aria-label="Figma prototype source">
          ...
          <label className={`field prototype-url-field${loading ? ' is-loading' : ''}`}>
        ...
        <div className="alt-sources">
          {VIDEO_UPLOAD_ENABLED ? (
            ...
            <button
              type="button"
              className="source-button is-disabled"
              disabled
              aria-label="Upload video — coming soon"
            >
              {uploadIcon}
              Upload video <span className="soon-note">(coming soon)</span>
            </button>
          )}
          <button
            type="button"
